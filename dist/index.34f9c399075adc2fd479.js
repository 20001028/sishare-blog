...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new VueRouter({
    ...
    routes: [{
        path: '/',
        redirect: '/blogs',
        component: () => __webpack_require__.e(/*! import() */ "src_components_common_header_vue").then(__webpack_require__.bind(__webpack_require__, /*! ./components/common/header.vue */ "./src/components/common/header.vue")),
        children: [{
            path: 'blogs',
